...
import com.plcoding.cryptotracker.crypto.presentation.coin_list.component.previewCoinNegativeChange
        ...
        Column(
            ...
            FlowRow(
                ...
                val absoluteChangedFormatted =
                    (coin.priceUsd.value * (coin.changePercent24Hrs.value / 100))
                        .toDisplayableNumber()
...
@PreviewLightDark
@Composable
private fun CoinDetailScreenPreviewNegative() {
    CryptoTrackerTheme {
        CoinDetailScreen(
            state = CoinListState(
                isLoading = false,
                selectedCoin = previewCoinNegativeChange,
            ),
            modifier = Modifier
                .background(MaterialTheme.colorScheme.background)
        )
